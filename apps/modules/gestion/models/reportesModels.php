...
class reportesModels extends Adodb {
    ...
    public function SP_REPORTE_COLOCADO($p){
        parent::ReiniciarSQL();
        parent::ConnectionOpen($this->dsn, 'SP_REPORTE_COLOCADO');
      // parent::SetParameterSP($p['vp_shi_codigo'], 'int');
      //  parent::SetParameterSP($p['vp_fac_cliente'], 'int');
        parent::SetParameterSP($p['VP_OP'], 'varchar');
        parent::SetParameterSP($p['VP_ID_AGE'], 'int');
        ...
        //parent::SetParameterSP($p['VP_MOTIVO'], 'int');
        parent::SetParameterSP($p['VP_MONEDA'], 'varchar');
        parent::SetParameterSP($p['VP_YEAR'], 'varchar');
        parent::SetParameterSP($p['VP_MOUNTH_A'], 'varchar');
        parent::SetParameterSP($p['VP_MOUNTH_B'], 'varchar');
        parent::SetParameterSP(USR_ID, 'int');//141
        // echo '=>' . parent::getSql().'<br>'; exit();
        $array = parent::ExecuteSPArray();
        return $array;
