...
class configuracionesController extends AppController {
    ...
    public function __construct(){
        ...
        $this->objDatos = new configuracionesModels();
    }
    ...
    public function get_list_configuraciones($p){
        $rs = $this->objDatos->get_list_configuraciones($p);
        //var_export($rs);
        $array = array();
        $lote = 0;
        foreach ($rs as $index => $value){
    ...
    public function get_list_configuraciones_cuadro_avance($p){
        $rs = $this->objDatos->get_list_configuraciones_cuadro_avance($p);
        //var_export($rs);
        $array = array();
        $lote = 0;
        foreach ($rs as $index => $value){
