...
<div style="width:1167px; height:700px; background:url(../img/bg_login.jpg); margin-left:auto; margin-right:auto;">
...
<div id="title_img"></div>
  <table width="961" height="387" border="0" cellpadding="0" style=" position:absolute; left:5%; z-index:5;">
    <tr>
      ...
      <td width="108" rowspan="3"><div style="background:url(../img/userTravel.jpg) no-repeat" class="img_user">
    ...
    <tr>
      <td height="33">&nbsp;</td>
      <td valign="bottom"><div id="cont_user" style="margin-right:-50px; float:right; display:none;"><span class="name_id">Usuario:</span><br />
            <div class="text_area">
    ...
    <tr>
      ...
      <td><div id="cont_pass"><span class="name_id">Contraseña:</span><br />
            <div class="text_area" style="left:530px; top:290px;">
              <input type="text" id="user" name="user" class="txt_us"/>
            </div>
      </div></td>
